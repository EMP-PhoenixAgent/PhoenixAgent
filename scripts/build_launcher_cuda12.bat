@echo off
rem Build PhoenixAgent-V0.8.6c-CUDA12.exe — the encapsulated launcher against
...
rem N:\Phoenix Agent\ALPHA\Launchers\PhoenixAgent-V0.8.6c-CUDA12.exe
...
copy /Y "N:\Phoenix Agent\phoenix-agent\target\release\phoenix-agent.exe" "N:\Phoenix Agent\ALPHA\Launchers\PhoenixAgent-V0.8.6c-CUDA12.exe"
echo LAUNCHER READY: N:\Phoenix Agent\ALPHA\Launchers\PhoenixAgent-V0.8.6c-CUDA12.exe
